...
INSERT INTO `movie` VALUES (1,'Relatos Salvajes','/TPI-Cine/assets/img/relatos_salvajes_1280_720.png','Un viaje en aviÃÂÃÂ³n, el encuentro con alguien del pasado, un pinchazo en una carretera, una multa, un atropello o una boda; historias independientes con un denominador comÃÂÃÂºn: la violencia sin control ni causa aparente, que impulsa a perder el control. En seis episodios diferentes los personajes se verÃÂÃÂ¡n empujados a situaciones al borde del abismo, perdiendo el control de sus vidas.','2014-08-21','Ricardo Darin, Oscar MartÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­nez, Leonardo Sbaraglia, ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂ¢ÃÂÃÂ¬ÃÂÃÂ°rica Rivas, Rita Cortese, Julieta Zylberberg, DarÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­o Grandinetti','Damian Szifron',122,4,1,NULL),(2,'The pianist','/TPI-Cine/assets/img/el_pianista.png','Wladyslaw Szpilman, un brillante pianista polaco de origen judío, vive con su familia en el ghetto de Varsovia. Cuando, en 1939, los alemanes invaden Polonia, consigue evitar la deportación gracias a la ayuda de algunos amigos. Pero tendrá que vivir escondido y completamente aislado durante mucho tiempo, y para sobrevivir tendrá que afrontar constantes peligros.','2003-03-06','Adrien Brody, Thomas Kretschmann, Frank Finlay, Maureen Lipman, Emilia Fox, Ed Stoppard, Julia Rayner, Jessica Kate Meyer','RomÃƒÂ¡n Polanski',151,4,1,NULL),(3,'Inglourious Basterds','/TPI-Cine/assets/img/inglorious.png','II Guerra Mundial, Francia, Shosanna presencia la ejecución de su familia por orden del coronel nazi Hans Landa. Huye a Paris y adopta una nueva identidad como propietaria de un cine. Mientras el teniente Aldo Raine adiestra a un grupo de soldados judíos. Los hombres de Raine y una actriz alemana que agente doble, deben llevar a cabo una misión que hará caer a los jefes del Tercer Reich. El destino quiere que todos se encuentren bajo la marquesina de un cine donde Shosanna espera para vengarse.','2009-08-31','Brad Pitt, Christoph Waltz, MÃƒÂ©lanie Laurent, Eli Roth, Diane Kruger, Daniel BrÃƒÂ¼hl, Til Schweiger, Michael Fassbender','Quentin Tarantino',153,3,2,'2022-10-31'),(4,'Thor: Love and thunder','/TPI-Cine/assets/img/thor.png','Secuela de \"Thor: Ragnarok\" en la que el Dios del Trueno contará con Lady Thor como acompañante.','2022-07-07','Chris Hemsworth, Christian Bale, Tessa Thompson, Jaimie Alexander, Taika Waititi, Russell Crowe,Natalie Portman','Taika Waititi',119,1,3,NULL),(5,'The godfather','/TPI-Cine/assets/img/elpadrino.png','Don Vito Corleone es el respetado y temido jefe de una de las cinco familias de la mafia de Nueva York en los años 40. El hombre tiene cuatro hijos: Connie, Sonny, Fredo y Michael, que no quiere saber nada de los negocios sucios de su padre. Cuando otro capo, Sollozzo, intenta asesinar a Corleone, empieza una cruenta lucha entre los distintos clanes.','1972-08-10','Marlon Brando, Al Pacino, Robert Duvall, James Caan, Richard Castellano, Diane Keaton','Francis Ford Coppola',177,5,1,NULL),(6,'Deadpool','/TPI-Cine/assets/img/deadpool.png','Wade Wilson, tras ser sometido a un cruel experimento científico, adquiere poderes especiales que le convierten en Deadpool. Armado con sus nuevas habilidades y un retorcido sentido del humor tratará de dar caza al hombre que casi destruye su vida.','2016-02-11','Ryan Reynolds, Morena Baccarin, Ed Skrein, T. J. Miller, Gina Carano, Leslie Uggams, Brianna Hildebrand, Stefan KapiÃ„ï¿½iÃ„â€¡','Tim Miller',109,4,2,NULL),(7,'The Hangover','/TPI-Cine/assets/img/thehangover.png','Cuatro amigos celebran la despedida de soltero de uno de ellos en Las Vegas. Pero, cuando a la mañana siguiente no pueden encontrar al novio y no recuerdan nada, deberán intentar volver sobre sus pasos, antes de que llegue la hora de la boda.','2009-06-05','Bradley Cooper, Ed Helms, Zach Galifianakis, Heather Graham, Mike Epps, Justin Bartha, Jeffrey Tambor','Todd Philips',100,4,3,NULL),(8,'Shrek 2','/TPI-Cine/assets/img/shrek.png','Shrek, nuestro ogro favorito, debe enfrentarse al mayor de los problemas que se podía imaginar: conocer a sus suegros.','2004-06-17','Mike Myers, Cameron Diaz, Eddie Murphy, Antonio Banderas, Julie Andrews, John Cleese, Rupert Everett, Jennifer Saunders, Larry King','Andrew Adamson',93,1,4,NULL),(9,'Transformers: Revenge of the Fallen','/TPI-Cine/assets/img/transformers.png','Han pasado dos años desde que los Transformers irrumpieran en la vida de Sam Witwicky. Ahora, el objetivo de Sam es ingresar en la Universidad y llevar una vida tranquila. Pero se ve otra vez involucrado en la guerra entre Autobots y Decepticons.','2009-06-25','Shia LaBeouf, Megan Fox, Josh Duhamel, Tyrese Gibson, John Turturro','Michael Bay',150,3,2,NULL),(10,'8 mile','/TPI-Cine/assets/img/8mile.png','Jimmy Smith, \'Rabbit\', vive en un barrio pobre de Detroit donde predomina la población negra. Él es un chico blanco apasionado por el hip-hop. Tiene problemas con su novia, pasa apuros económicos y sus relaciones con su madre no son muy armoniosas.','2002-01-23','Eminem, Kim Basinger, Brittany Murphy, Mekhi Phifer, Evan Jones, Omar Benson Miller, Eugene Byrd, De\'Angelo Wilson, Anthony Mackie, Michael Shannon','Curtis Hanson',106,5,1,NULL);
...
INSERT INTO `ubication` VALUES (1,4,1,3,'2022-09-03 22:00:00',1),(1,5,1,3,'2022-09-03 22:00:00',2),(5,3,1,3,'2022-09-03 22:00:00',2),(5,7,2,4,'2022-09-05 21:30:00',3),(3,9,1,3,'2022-09-03 22:00:00',4),(2,7,1,3,'2022-09-03 22:00:00',6),(4,6,2,4,'2022-11-15 10:02:54',8),(1,1,2,4,'2022-11-15 10:02:54',9);
...
-- Dump completed on 2022-11-09 17:00:50
