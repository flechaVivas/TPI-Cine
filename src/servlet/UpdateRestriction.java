...
/**
 * Servlet implementation class UpdateRestriction
 */
@WebServlet({ "/src/servlet/UpdateRestriction", "/UpdateRestriction" })
public class UpdateRestriction extends HttpServlet {
