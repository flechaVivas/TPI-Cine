...
<body>
    ...
    <%for (Movie m: movies){ %>
    	<div class="wrapper">
        	...
        	<div class="upde">
            	<a href="editMovie.jsp"><div class="boton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
