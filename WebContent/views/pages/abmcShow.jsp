...
<body>
	...
	<main>
    	...
    	<form name="showForm" action="" method="get">
        	...
        	<input type="submit" id="boton" value="+"></p>
    	</form>
    	<table class="table table-hover">
        	...
        	<tbody>
          		<tr>
            		...
            		<td>
                	<a href="abmcShow.html"><div class="input"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
