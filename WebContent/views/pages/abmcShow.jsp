    	...
    	<table class="table table-hover">
        	...
        	<tbody>
          		<tr>
            		...
            		<td>
                	<form class="registerForm" method="POST" action="/TPI-Cine/src/servlet/abmcShow?action=delete">
        				<button type="submit" name="idM" class="btn btn-outline-dark" value="<%=s.getMovie().getIdMovie()%>,<%=s.getMovieroom().getRoomNumber()%>,<%=s.getDt()%>">            	
